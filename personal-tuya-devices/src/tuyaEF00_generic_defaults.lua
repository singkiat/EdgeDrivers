...
local datapoint_types_to_fn = {
  ...
  carbonMonoxDetDatapoints = commands.carbonMonoxideDetector,
  carbonMonoxMeaDatapoints = commands.carbonMonoxideMeasurement,
  ...
  moesCurtainDatapoints = commands.moesCurtainMultiCommand,
...
local child_types_to_profile = {
  ...
  carbonMonoxDetDatapoints = "child-carbonMonoxideDetector-v1",
  carbonMonoxMeaDatapoints = "child-carbonMonoxideMeasurement-v1",
